...
describe('TaskBoardStateColumnViewHelper', () => {
  ...
  beforeEach(inject(
    [TaskBoardStateColumnViewHelper, TaskBoardGeneralHelper],
    (_columnHelper: TaskBoardStateColumnViewHelper, _generalHelper: TaskBoardGeneralHelper) => {
      ...
      stateTaskMaps = _columnHelper.createStateTaskMapList(
        referenceStates,
        _columnHelper.copyTaskList(completeTaskList),
      );
    },
  ));
  ...
  it('getMovedTaskWithNewPositionData - ' +
    ...
    const movedTaskToTest: ViewTask =
      service.getMovedTaskWithNewPositionData(
        previousIndex,
        previousContainer,
        currentIndex,
        currentContainer,
  ...
  it(
    'getMovedTaskWithNewPositionData - ' +
