...
describe('TaskBoardGeneralHelper', () => {
    ...
    it('addTaskAndUpdateTaskList - task list with only one state: Add task between tasks with id 3 and 0 of the list', () => {
        const completeList: ViewTask[] = [
            new ViewTask(0, 'test0', 'test0-description', [], 1, 0, 1, null, 1),
            new ViewTask(3, 'test3', 'test3-description', [], 0, 0, 1, 0, 1),
            new ViewTask(6, 'test6', 'test6-description', [], 1, 0, 1, 3, 1),
    ...
    it('addTaskAndUpdateTaskList - task list with multiple states: Add task between tasks with id 4 and 9 of the list', () => {
        const completeList: ViewTask[] = [
            new ViewTask(0, 'test0', 'test0-description', [], 1, 0, 1, null, 1),
            new ViewTask(3, 'test3', 'test3-description', [], 0, 0, 1, 0, 1),
            new ViewTask(6, 'test6', 'test6-description', [], 1, 0, 1, 3, 1),
