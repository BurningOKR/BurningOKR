...
import org.burningokr.service.structureutil.CyclePreparationCloningService;
...
public class CycleServiceTest {
  ...
  private CompanyHistory createDummyHistory(long dummyId) {
    CompanyHistory dummyCompanyHistory = new CompanyHistory();
    dummyCompanyHistory.setId(dummyId);
    return dummyCompanyHistory;
  }
  ...
  public void processAutomaticCycleSwitch_oneActiveCycleFromOneCompany_expectedNoCycleSwap() {
    CompanyHistory companyHistoryA = createDummyHistory(100L);
    Cycle cycleForHistoryA1 = createDummyCycleWithStateAndEndDateInFuture(CycleState.ACTIVE, 10);

    // Mock return data
    ArrayList<CompanyHistory> companyHistoriesToReturn = new ArrayList<>();
    companyHistoriesToReturn.add(companyHistoryA);
    ...
    when(cycleRepository
            .findByCompanyHistoryAndPlannedStartBeforeOrEqualAndNotCycleStateOrderByEndDateDescending(
                companyHistoryA, LocalDate.now(), CycleState.CLOSED))
  ...
  public void
    ...
    CompanyHistory companyHistoryB = createDummyHistory(200L);
    ...
    ArrayList<CompanyHistory> companyHistoriesToReturn = new ArrayList<>();
    companyHistoriesToReturn.add(companyHistoryA);
    companyHistoriesToReturn.add(companyHistoryB);
    ArrayList<Cycle> cyclesToReturnForCompanyHistoryA = new ArrayList<>();
    cyclesToReturnForCompanyHistoryA.add(cycleForCompanyA3);
    cyclesToReturnForCompanyHistoryA.add(cycleForCompanyA2);
    cyclesToReturnForCompanyHistoryA.add(cycleForCompanyA1);
    ...
    when(cycleRepository
            .findByCompanyHistoryAndPlannedStartBeforeOrEqualAndNotCycleStateOrderByEndDateDescending(
                companyHistoryB, LocalDate.now(), CycleState.CLOSED))
