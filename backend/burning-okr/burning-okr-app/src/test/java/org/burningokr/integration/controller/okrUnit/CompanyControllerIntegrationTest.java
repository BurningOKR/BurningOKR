...
class CompanyControllerIntegrationTest {
  ...
  @Test
  void updateCompanyById_shouldReturnStatus200_whenCompanyDtoIsValid() throws Exception {
  ...
  @Test
  void updateCompanyById_shouldReturnStatus400_whenLabelIsNull() throws Exception {
