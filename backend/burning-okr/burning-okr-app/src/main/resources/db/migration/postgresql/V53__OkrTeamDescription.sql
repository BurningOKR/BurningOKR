CREATE TABLE public.okr_team_description
(
    id bigint NOT NULL,
...
(
    ...
    CONSTRAINT okr_member_description_fkey FOREIGN KEY (okr_description_id)
        REFERENCES public.okr_team_description (id) MATCH SIMPLE
...
ALTER TABLE public.okr_department ADD okr_team_description_id bigint;
ALTER TABLE public.okr_department ADD CONSTRAINT okr_team_description_fkey FOREIGN KEY (okr_team_description_id)
    REFERENCES public.okr_team_description (id) MATCH SIMPLE
    ON UPDATE NO ACTION ON DELETE NO ACTION;
