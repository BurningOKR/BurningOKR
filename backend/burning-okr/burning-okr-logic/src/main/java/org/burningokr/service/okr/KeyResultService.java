...
public class KeyResultService {
  ...
  public KeyResult updateKeyResult(KeyResult updatedKeyResult, User user) {
    ...
    boolean keyResultProgressChanged =
        createdOrProgressChanged(referencedKeyResult, updatedKeyResult);
  ...
  private boolean createdOrProgressChanged(KeyResult oldKeyResult, KeyResult updatedKeyResult) {
    return oldKeyResult == null
        || oldKeyResult.getCurrentValue() != updatedKeyResult.getCurrentValue()
