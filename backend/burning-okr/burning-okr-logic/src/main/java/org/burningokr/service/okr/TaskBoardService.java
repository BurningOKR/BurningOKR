...
public class TaskBoardService {
    ...
    public TaskBoard copyTaskBoardWithParentOkrUnitOnly(TaskBoard taskBoardToCopy, OkrDepartment okrDepartment) {
    ...
    public TaskBoard cloneTaskBoard(OkrDepartment copy, TaskBoard taskBoardToCopy) {
        ...
        Collection<TaskState> copiedStates = this.copyTaskStateListAndSetTaskBoard(taskBoardToCopy.getAvailableStates(),copiedTaskBoard);
        ...
        copiedTaskBoard.setTasks(taskService.copyTasksAndBindToNewCopyOfTaskStatesListAndTaskBoard(notFinishedTasks,copiedStates, copiedTaskBoard));
    ...
    public Collection<TaskState> copyTaskStateListAndSetTaskBoard(Collection<TaskState> statesToCopy,TaskBoard parentTaskBoard) {
    ...
    public Collection<Task> findUnfinishedTasks(TaskBoard taskBoard) {
        ...
        Collection<Task> notFinishedTasks = taskRepository.findNotFinishedTasksByTaskBoard(taskBoard, finishedState);
        return notFinishedTasks;
    }

    public void logTaskBoard(TaskBoard taskBoard) {
        this.logger.info("id: " + taskBoard.getId() + "parentDepartment: "+ taskBoard.getParentOkrDepartment().getId());
    }
}
