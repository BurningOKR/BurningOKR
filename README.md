...
You can use our [docker-compose-prod.yml](/docker/docker-compose.yml) file for easy use and compatibility!  
1. Download the [docker-compose-prod.yml](/docker/docker-compose.yml) file
